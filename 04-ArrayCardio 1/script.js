    ...
    //------------ FIRST VERSION -------------------
    // const filteredArray = inventors.filter(function (inventor) {
    ...
    const mapped = inventors.map(function(inventor){
    ...
    //------------ IMPROVED VERSION -------------------
    const sorted = inventors.sort((a, b) => a.year > b.year ? 1 : -1); //using ternary operator
    ...
    const alphabetical = people.sort(function(a, b) {
